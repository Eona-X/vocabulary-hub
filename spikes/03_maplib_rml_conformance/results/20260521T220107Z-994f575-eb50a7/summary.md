# Spike 3 summary — 20260521T220107Z-994f575-eb50a7

| engine | pass | fail | error | skipped | total | pass-rate |
|---|---:|---:|---:|---:|---:|---:|
| morph | 87 | 12 | 40 | 185 | 324 | 26.9% |
...
| RMLTC0001b-CSV | pass | error |
| RMLTC0001b-JSON | pass | error |
| RMLTC0001b-XML | pass | error |
| RMLTC0002a-CSV | pass | error |
| RMLTC0002a-JSON | pass | error |
| RMLTC0002a-XML | pass | error |
| RMLTC0002b-CSV | pass | error |
| RMLTC0002b-JSON | pass | error |
| RMLTC0002b-XML | pass | error |
...
| RMLTC0012a-CSV | pass | error |
| RMLTC0012a-JSON | pass | error |
| RMLTC0012a-XML | pass | error |
| RMLTC0012b-CSV | pass | error |
| RMLTC0012b-JSON | pass | error |
| RMLTC0012b-XML | pass | error |
